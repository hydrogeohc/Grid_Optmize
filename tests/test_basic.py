...
from grid_core.db import Base, GridState, OptimizationResult, get_engine, create_tables, get_session
...
class TestDatabase:
    ...
    def test_optimization_result_model(self, test_session):
        ...
        opt_result = OptimizationResult(
            region="test-region",
            optimized_supply=105.0,
            optimized_demand=95.0,
            losses=5.0
        )
...
class TestGridOperations:
    ...
    def test_optimize_grid_function(self):
        ...
        from grid_core.db import get_engine, create_tables, get_session
